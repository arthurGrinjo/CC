 ...
 */
final class Version20251001091724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (name VARCHAR(180) NOT NULL, start_datetime DATETIME NOT NULL, end_datetime DATETIME NOT NULL, id INT AUTO_INCREMENT NOT NULL, uuid BINARY(16) NOT NULL, chat_id INT DEFAULT NULL, location_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_3BAE0AA7D17F50A6 (uuid), UNIQUE INDEX UNIQ_3BAE0AA71A9A7125 (chat_id), INDEX IDX_3BAE0AA764D218E (location_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
